...
public class SocketCliente {
	...
	public static final String IP_SERVER = "localhost";// si estuviera en otra máquina
													   // se pondría la dirección IP (IP ej: 192.168.1.18)
	...
	public static void main(String[] args) {
		...
		} catch (UnknownHostException e) { //no existe IP
