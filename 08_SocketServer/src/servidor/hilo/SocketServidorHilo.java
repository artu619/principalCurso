...
//En este caso, vamos a abrir un hilo por cada petición que haga el servidor
//para así poder procesar varias peticiones simultáneas de diferentes clientes
public class SocketServidorHilo {
	...
	public static void main(String[] args) {
		...
		try (ServerSocket servidor = new ServerSocket()){			
			...
			while (true) {
				//Por cada petición de cliente aceptada se me crea un objeto socket diferente
				Socket socketAlCliente = servidor.accept();
				System.out.println("SERVIDOR: petición numero " + ++peticion + " recibida");
