...
public class PruebaGenericos {
	...
	public static void main(String[] args) {
		...
		System.out.println("Mismo contenido: " + p1.equals(p2));
		System.out.println("Mismo objeto: " + (p1 == p2));
		System.out.println();
		...
		//Almacen en la primera parte solo puede aceptar <Persona>
		//Ahora generamos un almacen puede aceptar <String>
		...
		//raw type --> desactiva la verificación de tipos al compilar
		Almacen almacenGenerico = new Almacen();
		almacenGenerico.setValorAlmacenado(p1); //guardo Persona
		almacenGenerico.setValorAlmacenado(s); // guardo String
		
		//pero tenemos que castear el valor para usarlo
		String s2 = (String) almacenGenerico.getValorAlmacenado();
		//esto da problemas y hay que evitar utilizar raw types
